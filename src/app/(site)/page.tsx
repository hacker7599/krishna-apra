      ...
      <SiteSection tone="white" width="content" className="!border-b-0">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-xl space-y-3">
            <SectionHeader eyebrow="Registration" title="Trials are open" />
            <p className="text-base font-medium leading-relaxed text-slate-600">
              Submit the digital registration form with academy details, player profile, and optional payment proof—the same structure as the
              official paper trial form, upgraded for speed and clarity.
            </p>
